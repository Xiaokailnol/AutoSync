...
git clone --depth 1 -b master https://github.com/sbwml/luci-app-mentohust openwrt-mentohust mv -n openwrt-mentohust/{mentohust,luci-app-mentohust} ./; rm -rf openwrt-mentohust
